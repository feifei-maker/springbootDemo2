...
import com.whc.springboot.modules.account.dao.ResourceDao;
import com.whc.springboot.modules.account.dao.RoleResourceDao;
...
public class ResourceServiceImpl implements ResourceService {
    ...
    public Result<Resource> editResource(Resource resource) {
        ...
        if (resourceTemp != null && resourceTemp.getResourceId() != resource.getResourceId()) {
            return new Result<Resource>(Result.ResultStatus.FAILED.status, "Resource permission is repeat.");
        }
